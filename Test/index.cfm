    ...
    <cfform name="EnterNew" method="post" action="index.cfm?StepNum=10">
    	<table width="100%" border="1">
            ...
            <tr>
                ...
                Student Teacher (FP with D51)     <cfinput type="checkbox" name="cbStuTeachCDE">Student Teacher (FP with CDE)</td>
                    ...
                    <td width="20%">
                    	<cfoutput>
                        	...
                        	<cfif #GetData.StudentTeacherCDE# eq 'on'>
                            	<cfinput type="checkbox" name="cbStuTeachCDE" checked="yes"> Student Teacher (FP with CDE)
                            <cfelse>
                            	<cfinput type="checkbox" name="cbStuTeachCDE"> Student Teacher (FP with CDE)
                            </cfif>
						</cfoutput>
                    </td>
                    <td width="20%">
                        ...
                        <cfif #GetData.Attachment_yn# eq 'Y'>
                            ...
                            <cfif #GetAttachments.RecordCount# gt 0>
                            	...
                            	<cfloop from="1" to="#GetAttachments.RecordCount#" index="i">
                                	<a href="\\ifasbitech\bi-tech$\HR Finger Print\Files\#GetAttachments.FileName[i]#">#GetAttachments.FileName[i]#</a><br />
                                </cfloop>
                                </cfoutput>
...
<cfif isDefined("fileUpload")>
	<cffile action="upload"
         	...
         	destination="\\ifasbitech\bi-tech$\HR Finger Print\Files\"
