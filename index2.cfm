	...
	<cfif isdefined ("form.submituser")>        
        ...
        <cfelseif #getaccounts.cn# eq 'bshay' or #getaccounts.cn# eq 'rachelt' or #getaccounts.cn# eq 'jenann' or #getaccounts.cn# eq 'lhudson' or #getaccounts.cn# eq 'cstarr' or #getaccounts.cn# eq 'crystal' or #getaccounts.cn# eq 'sguadnol' or #getaccounts.cn# eq 'hart' or #getaccounts.cn# eq 'bchandle' or #getaccounts.cn# eq 'cness' or #getaccounts.cn# eq 'scalvert' or #getaccounts.cn# eq 'bnieslan' or #getaccounts.cn# eq 'bandrews' or #getaccounts.cn# eq 'anhudso'>
            ...
            <cfif #GetUserInfo.RecordCount# gt 0>
                ...
                <cflocation url="index2.cfm?StepNum=1" addtoken="no">
            <cfelse>
			<!---
...
<cfif isdefined('submit')>
    ...
    <cfelse>
		<cfif selection eq 'N'>
            <cflocation url="index2.cfm?StepNum=10">
        <cfelseif selection eq 'Q'>
            <cflocation url="index2.cfm?StepNum=20">
        <cfelseif selection eq 'R'>
        	<cflocation url="index2.cfm?StepNum=50">
        <cfelse>
         </cfif>	
	</cfif>
</cfif>
	<cfform name="Select" action="index2.cfm?Stepnum=1" method="post">
    	<table width="100%">
        	<tr>
...
<cfelseif url.Stepnum eq 10>
    ...
    <cfif isdefined('logout')>    
    	<cflocation url="index2.cfm?StepNum=999">
    </cfif>
	...
	<cfif isdefined('submit')>
        ...
        <cflocation url="index2.cfm?StepNum=998">
    </cfif>
    
    <!--- Enter new data form --->
    <cfform name="EnterNew" method="post" action="index2.cfm?StepNum=10">
...
<cfelseif url.StepNum eq 20>
	...
	<cfif isdefined('form.select')>
    	<cflocation url="index2.cfm?StepNum=1">
    </cfif>
        ...
        <cfoutput>
            <table border="1" width="100%">
                ...
                <cfloop from="1" to="#SearchFP.RecordCount#" index="i">
                	<tr>
                    	<td><a href="index2.cfm?StepNum=21&fpid=#SearchFP.FPID[i]#">#SearchFP.LName[i]#</a></td>
	...
	<cfform name="Search" method="post" action="index2.cfm?StepNum=20">
    	<center>
    		<table>
            	<tr>
...
<cfif isdefined('form.add')>
	<cflocation url="index2.cfm?StepNum=30&update=Y">
</cfif>
...
<cfif isdefined('form.update')>
    ...
    <cflocation url="index2.cfm?StepNum=997">
</cfif>
...
<cfquery name="GetData" datasource="hrinfopath">
    ...
    <cfquery name="LogInsert" datasource="hrinfopath">
        ...
        <cfform name="Update" method="post" action="index2.cfm?StepNum=21">
        	<table width="100%" border="1">
                <th align="center" colspan="4">Enter New Information</th>
                <tr>
                    <td width="20%">
...
<cfif isDefined("fileUpload2") and #fileUpload2# gt ''>
	<cffile action="upload"
...
<cfif isdefined('Session.FileName') or isdefined('Session.FileName2')>
	<cfif isdefined('update')>
		<cflocation url="index2.cfm?StepNum=996&update=Y">
    <cfelse>
    	<cflocation url="index2.cfm?StepNum=996">
    </cfif>
</cfif>
...
<cfelseif url.StepNum eq 40>
    ...
    <cfif isdefined('form.EditExisting')>
        ...
        <cflocation url="index2.cfm?StepNum=21&FPID=#GetDataNew.FPID#">
    </cfif>
    ...
    <cfform name="CheckData" method="post" action="index2.cfm?StepNum=40">
		<cfoutput>
            <table border="1" width="100%">
                <tr>
                    <td>&nbsp;</td>
...
<cfelseif url.StepNum eq 996>
    ...
    <cfif isdefined('update')>
    	<cflocation url="index2.cfm?StepNum=21&fpid=#Session.FPID#">
    <cfelse>
        <cflocation url="index2.cfm?StepNum=1">
    </cfif>
...
<cfelseif url.StepNum eq 50>
	...
	<cfif isdefined('form.submit')>
    	<cfif #form.export# eq 'All'>
        	<cflocation url="index2.cfm?StepNum=51">
        <cfelseif #form.export# eq 'Query'>
        	<cflocation url="index2.cfm?StepNum=52">
        <cfelseif #form.export# eq 'Vol'>
        	<cflocation url="index2.cfm?StepNum=54">
        <cfelseif #form.export# eq 'DNR'>
        	<cflocation url="index2.cfm?StepNum=55">
        <cfelseif #form.export# eq 'Felony'>
        	<cflocation url="index2.cfm?StepNum=56">
        <cfelseif #form.export# eq 'Mis'>
        	<cflocation url="index2.cfm?StepNum=57">
        <cfelseif #form.export# eq 'Unread'>
        	<cflocation url="index2.cfm?StepNum=58">
        <cfelseif #form.export# eq 'Active'>
        	<cflocation url="index2.cfm?StepNum=59">
        <cfelseif #form.export# eq 'ST'>
        	<cflocation url="index2.cfm?StepNum=60">
        <cfelseif #form.export# eq 'STA'>
        	<cflocation url="index2.cfm?StepNum=61">
        </cfif>
    </cfif>
    
    <cfform name="selectexport" method="post" action="index2.cfm?StepNum=50">
...
<cfelseif url.StepNum eq 52>
	<cfif isdefined('form.search')>
        ...
        <cflocation url="index2.cfm?StepNum=53">
    </cfif>

	<cfform name="Search" method="post" action="index2.cfm?StepNum=52">
    	<center>
    		<table>
            	<tr>
                	<td colspan="2" align="center">Search By:</td>
...
<cfelseif url.Stepnum eq 998>
    ...
    <cfif #CheckSSN.RecordCount# gt 0>
    	<cflocation url="index2.cfm?StepNum=40">
    </cfif>
    ...
    <cfif #Session.Attachment# eq 'Y'>
    	<cflocation url="index2.cfm?StepNum=30">
    </cfif>
...
<cfelseif url.StepNum eq 999>
	...
	<cflocation url="https://intranet.mesa.k12.co.us/2003/apps/FingerPrint/index2.cfm">
<!--- End of Steps --->
</cfif>
   			<!-- InstanceEndEditable --> 	
  	</div>
