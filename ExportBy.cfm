<!--- Export All data by Name or SSN 
		Create On 05/23/11
		By: B.J. Shay 
		Modification:
		06/17/11 - BJS - Added "Undetermined" 
...
<cfquery name="GetFPData" datasource="hrinfopath">
    ...
    WHERE		(LName LIKE '%#Session.Search_LName#%' AND FName LIKE '%#Session.Search_FName#%' AND FormerLName LIKE '%#Session.Search_FLName#%' AND SSN LIKE '%#Session.Search_SSN#%')
</cfquery>

	<cfset delim = chr(9)>
	<cfset NewLine = Chr(13) & Chr(10)>
	<cfset HeaderLine = "FPID"&#delim#&"Last Name"&#delim#&"First Name"&#delim#&"SSN"&#delim#&"Former Last Name"&#delim#&"DOB"&#delim#&"Finger Print Date"&#delim#&"Finger Print Unreadable"&#delim#&"Attachments y/n"&#delim#&"Undetermined y/n"&#delim#&"Misdemeanor y/n"&#delim#&"Felony y/n"&#delim#&"Comment"&#delim#&"Do Not Rehire y/n"&#delim#&"Address"&#delim#&"city"&#delim#&"State"&#delim#&"Zip"&#delim#&"Phone"&#delim#&"Email"&#delim#&"Volunteer y/n"&#delim#&"Student Teacher (FP with D51)"&#delim#&"Student Teacher (FP w CDE)"&#delim#&"STA"&#delim#&"UpdatedBy"&#delim#&"UpdatedOn"&#NewLine#>
...
<cfheader name="Content-Disposition" value="attachment;filename=FingerPrint_By.xls">
